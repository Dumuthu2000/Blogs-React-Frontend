    ...
    return(
        <div className='writeContainer'>
            <div className="writeContent">
                <input type="text" className="titleInput" placeholder='Title' onChange={(e)=>{
                    setTitle(e.target.value)
                }}/>
            </div>
            <div className="writeContent">
                <div className="editorBlock">
                    <ReactQuill theme='snow' className='reactQuill' value={content}  onChange={setContent}/>
